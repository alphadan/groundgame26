...
exports.seedPACounties = functions.https.onCall(async (data, context) => {
    ...
    await batch.commit();
    return { success: true, message: "67 PA counties seeded/updated" };
});
//# sourceMappingURL=seedCounties.js.map